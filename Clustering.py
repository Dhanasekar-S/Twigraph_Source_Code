...
while n_of_clusters != 1:
    ...
    score_query = [(x + y) / 2 for x, y in zip(score_query, scores[merge_index])]
    ...
    print(dind)
    if dind <query_index:
        print(Analysis.twitterdata.files_in_dir[dind][:-11]+ " entering the cluster")
        writer.write(Analysis.twitterdata.files_in_dir[dind][:-11]+ " entering the cluster")
    else:
        print(Analysis.twitterdata.files_in_dir[dind+1][:-11]+" entering the cluster")
        writer.write(Analysis.twitterdata.files_in_dir[dind+1][:-11]+" entering the cluster")
